        ...
        select = {
          ...
          keymaps = {
            ...
            ["am"] = { query = "function.outer",
              desc = "Select outer part of a method/ function call"},
            ["im"] = { query = "function.inner",
              desc = "Select inner part of a method/ function call"},

            ["ac"] = { query = "class.outer",
              desc = "Select outer part of a class call"},
            ["ic"] = { query = "class.inner",
              desc = "Select inner part of a class call"},
          }
        },
        swap = {
          enable = true,
